...
2. The app fetches data from `/backup-download-user`
...
3. After login, the app fetches data from `/backup-download-all`
4. Data is sent to Google Drive via `/backup-upload-drive`
