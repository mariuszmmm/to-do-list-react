...
const cronHandler: Handler = async (event, context) => {
  const logPrefix = "[cronNotifications]";
        ...
        if (notif.subscriptionId) {
          pushPromise = axios.post(
            "https://onesignal.com/api/v1/notifications",
            {
              ...
              headings: {
                pl: currLang === "pl" ? heading : labels.pl.heading,
                en: currLang === "en" ? heading : labels.en.heading,
                de: currLang === "de" ? heading : labels.de.heading,
              },
              contents: {
                pl: finalContent,
                en: finalContent,
