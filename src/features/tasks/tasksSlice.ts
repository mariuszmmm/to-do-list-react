...
const tasksSlice = createSlice({
  ...
  reducers: {
    ...
    setToUpdate: (state, { payload }: PayloadAction<TaskListData | null>) => {
      state.toUpdate = payload;
    },
    setListStatus: (
      state,
      {
...
export const selectToUpdate = (state: RootState) =>
  selectTasksState(state).toUpdate;
