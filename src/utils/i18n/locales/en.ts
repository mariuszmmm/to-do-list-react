...
const langEn: typeof langPl = {
  ...
  accountPage: {
    ...
    backup: {
      ...
      uploadTooltip: "Upload backup to Google Drive",
      uploadSuccess: "Backup uploaded to Google Drive successfully!",
      uploadError: "Error uploading backup",
      restore: "Restore from Google Drive",
      restoreTooltip: "Restore data from Google Drive backup",
      restoreSuccess: "Backup restored successfully! Restored {{count}} lists.",
      restoreError: "Error restoring backup",
      authorizeGoogle: "Authorize Google",
      authorizeGoogleTooltip: "Authorize Google Drive access",
      processing: "Processing...",
      authSuccess: "Authorization successful!",
      authError: "Authorization error",
      uploading: "Uploading backup to Google Drive...",
      restoring: "Restoring backup from Google Drive...",
      notAuthorized: "Not authorized with Google Drive",
      configError: "Google Drive configuration missing",
