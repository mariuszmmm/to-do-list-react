  ...
  modal: {
    ...
    sendMessage: {
      ...
      autoReply: {
        ...
        intro:
          "Your message has been received. We will get back to you as soon as possible – usually within 1–2 business days.",
        messageLabel: "Your message",
        regards: "Best regards,\nMariusz Matusiewicz",
        footer:
          "This message was automatically generated by the contact form of the To-Do List App. Please do not reply directly to this email.",
      },
    },
    backupAuthError: {
